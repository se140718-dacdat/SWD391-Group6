    ...
    <div id="StudentHeader">
      <div id="navbar">
        <div className="nav-list">
          ...
          <NavLink to={"/student/companies"} className="nav-item">
            <span>career opportunities</span>
          </NavLink>
          <NavLink to={"/student/history/1"} className="nav-item">
            <span>request</span>
          </NavLink>
          <NavLink to={"/student/profile"} className="nav-item">
            <span>profile</span>
          </NavLink>
          <a onClick={logout} className="nav-item session js-login-btn">
            <span>logout</span>
          </a>
        </div>
      </div>
