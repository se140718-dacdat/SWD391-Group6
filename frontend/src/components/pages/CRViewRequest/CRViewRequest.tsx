      ...
      <div id="content">
        <div className="search-bar">
          ...
          <div className="cr-search">
            ...
            <i className="pi pi-search vertical-algin"></i>
          </div>
        </div>

        <div className="content-title">
          <p style={{ flexGrow: 0.35 }}>student name</p>
        ...
        <div id="student-list">
          ...
          <div className="student-item">
            ...
            <button className="col4 btn js-btn-detail btn-detail">
              detail
            </button>
            <button
              className="col5 btn js-btn-delete btn-accept"
              onClick={() => processRequest("SE140718", 1)}
            >
              accept
            </button>
            <button
              className="col6 btn js-btn-delete btn-delete"
              onClick={() => processRequest("SE140718", 2)}
            >
              decline
            </button>
          </div>
